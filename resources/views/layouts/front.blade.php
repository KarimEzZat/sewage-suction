...
<head>
    ...
    <meta name="author"
          content="
شركة وايت شفط صرف صحي بالرياض هي شركة متخصصة في تقديم خدمات شفط الصرف الصحي. تقدم الشركة خدماتها على مدار 24 ساعة وتتميز بالكفاءة والسرعة. تقدم الشركة خدمات متنوعة تشمل شفط المياه وتسليك المجاري. تعتمد الشركة في خدماتها على أحدث السيارات التي تعمل على شفط المياه بكل قوة.">
    <!-- Meta Description -->
    <meta name="description"
          content="
شركة وايت شفط صرف صحي بالرياض هي شركة متخصصة في تقديم خدمات شفط الصرف الصحي. تقدم الشركة خدماتها على مدار 24 ساعة وتتميز بالكفاءة والسرعة. تقدم الشركة خدمات متنوعة تشمل شفط المياه وتسليك المجاري. تعتمد الشركة في خدماتها على أحدث السيارات التي تعمل على شفط المياه بكل قوة.">
    <meta property="og:title"
          content="شركة وايت الرياض لتسليك المجاري ووايت شفط صرف صحي بجميع احياء الرياض حيث تعتبر خدمة شفط صرف صحي أمرًا ضروريًا للحفاظ على نظافة وصحة منزلك"/>
...
شركة وايت شفط صرف صحي بالرياض هي شركة متخصصة في تقديم خدمات شفط الصرف الصحي. تقدم الشركة خدماتها على مدار 24 ساعة وتتميز بالكفاءة والسرعة. تقدم الشركة خدمات متنوعة تشمل شفط المياه وتسليك المجاري. تعتمد الشركة في خدماتها على أحدث السيارات التي تعمل على شفط المياه بكل قوة."/>
    ...
    <meta property="og:site_name" content="شركة وايت الرياض شركة وايت شفط صرف صحي بالرياض"/>
    <meta property="og:image:secure_url" content="{{asset('assets/Images/'.$companies->first()->photo)}}"/>


    <meta property="og:image:alt" content="شركة وايت شركة وايت شفط صرف صحي بالرياض"/>
    <meta name="twitter:card" content="summary_large_image"/>
    <meta name="twitter:title" content="شركة وايت الرياض شركة وايت شفط صرف صحي بالرياض"/>
            ...
            <div class="col-lg-12">
                <div class="footer-top flex-column">
                    ...
                    <div class="footer-social text-center">
                        ...
                        <a target="-_blank" class="phone-cell ml-3" href="tel:+966546913538" title="اتصل بنا"><i
...
<div class="fixed-btn">
    ...
    <a href="tel:+966546913538" class="ms-call-button">
